...
public class Nicknames {
	...
	public static void ChangeNick(String nn, String nick){
		...
		try {
			...
			if (nickList.containsKey(nick.toLowerCase()) || nickList.containsValue(nick) || ShadyBotty.database.getPrivileges(nick.toLowerCase()) != null ||  Database.usersIni.get(nick.toLowerCase()) != null || Database.currentUsers.contains(nick.toLowerCase())) {
